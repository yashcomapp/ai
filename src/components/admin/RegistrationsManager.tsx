  ...
  if (error) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
        ...
        <button className="btn btn-primary" onClick={() => fetchRegistrations()} style={{ marginTop: '16px' }}>Retry</button>
      </div>
    );
  }
                ...
                <tr key={reg.id} style={{ borderBottom: '1px solid var(--border-light)' }}>
                  ...
                  <td style={{ padding: '10px' }}>
                    <div style={{ display: 'flex', gap: '6px' }}>
                      <button className="btn btn-secondary" style={{ fontSize: '10px', padding: '4px 8px' }} onClick={() => { setSelectedReg(reg); setViewModalOpen(true); }} title="View">View</button>
                      ...
                      <button className="btn btn-danger" style={{ fontSize: '10px', padding: '4px 8px' }} onClick={() => handleDelete(reg.id)} title="Delete">Delete</button>
                    </div>
                  </td>
                </tr>
              ))
