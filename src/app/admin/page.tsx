          ...
          <>
            ...
            <div className="card" style={{ background: 'var(--surface)', padding: '10px 12px', borderRadius: 'var(--radius)', border: '1px solid var(--border)', marginBottom: '10px', boxShadow: 'var(--shadow-sm)' }}>
              ...
              <div className="admin-quick-actions-grid">
                ...
                <button className="btn btn-secondary" style={{ width: '100%', fontSize: '11.5px', fontWeight: 600, padding: '6px 8px', whiteSpace: 'nowrap', borderRadius: 'var(--radius-sm)', background: 'var(--surface-2)', color: 'var(--text)', border: '1px solid var(--border)' }} onClick={() => router.push('/admin/disputes')}>⚖️ Exam Disputes</button>
