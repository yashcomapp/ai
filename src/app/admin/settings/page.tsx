          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div className="card" style={{ background: 'var(--surface)', padding: '20px', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border-light)' }}>
              ...
              <button 
                ...
                style={{ background: restoreJson ? 'var(--success)' : 'var(--border)', color: 'var(--text-white)', border: 'none' }}
              >
        ...
        {activeTab === 'utils' && (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px' }}>
            ...
            <div className="card" style={{ background: 'var(--surface-2)', padding: '20px', borderRadius: 'var(--radius-lg)', border: '1.5px solid var(--border-light)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: '12px' }}>
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '6px' }}>
                  ...
                  <span style={{ fontSize: '10px', background: 'var(--purple)', color: 'var(--text-white)', padding: '2px 6px', borderRadius: '4px', fontWeight: 800 }}>SSOT</span>
                </div>
            ...
            <div className="card" style={{ background: 'var(--warning-bg)', padding: '20px', borderRadius: 'var(--radius-lg)', border: '1px solid var(--warning-border)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: '10px' }}>
              ...
              <button 
                className="btn btn-secondary" 
                style={{ background: 'var(--warning)', color: 'var(--text-white)', border: 'none', fontSize: '11px', padding: '6px 12px' }}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div className="card" style={{ background: 'var(--surface)', padding: '20px', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border-light)', display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
              ...
              <button 
                ...
                style={{ flex: '1', minWidth: '160px', background: orphanedData && cleanupStats.totalOrphaned > 0 ? 'var(--danger)' : undefined, color: orphanedData && cleanupStats.totalOrphaned > 0 ? 'var(--text-white)' : undefined }}
              >
