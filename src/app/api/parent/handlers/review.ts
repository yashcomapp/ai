  ...
  try {
    ...
    const mappedPracticeReviews = pracSnaps.docs.map(doc => {
      ...
      return {
        ...
        idealTimeSeconds: data.idealTimeSeconds || 0,
        minRealisticTimeSeconds: data.minRealisticTimeSeconds || 0,
        sincerityPacingScore: data.sincerityPacingScore ?? null,
        isFastFluency: data.isFastFluency || false,
        isSolvedTooFast: data.isSolvedTooFast || false,
        feedbackBadge: data.feedbackBadge || null,
        parentAdvisory: data.parentAdvisory || null,
        parentAdvisoryMr: data.parentAdvisoryMr || null,
        status,
        reviewedByActor: resolvedActor,
        proctoringViolationTriggered: data.proctoringViolationTriggered || false
      };
